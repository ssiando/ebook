...
// Dev-only bypass: skips Supabase entirely and signs the app in with a
// hardcoded token/user. Never enable this in a deployed environment.
...
export function AuthProvider({ children }: PropsWithChildren) {
  ...
  const [auth, setAuth] = useState<AuthModel | undefined>(
    AUTH_BYPASS ? MOCK_AUTH : authHelper.getAuth(),
  );
  const [currentUser, setCurrentUser] = useState<UserModel | undefined>(
    AUTH_BYPASS ? MOCK_USER : undefined,
  );
